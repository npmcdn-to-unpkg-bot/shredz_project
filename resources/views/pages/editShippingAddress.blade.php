                ...
                <div class="account-info edit">
                  <div class="alert alert-success" >
                    ...
                    <div class="account-box">
                      ...
                      <div>
                          <select id="addr_state" name="addr_state">
                            <option selected="selected" value="">Choose State:</option>
                          </select>
                      </div>
                      <input type="hidden" id="editing_addr_uid" name="editing_addr_uid" value="{{ $user['editing_addr_uid'] }}" />
                  </div>
                  <div class="action">
                      <!-- <button>DISCARD</button> -->
                      <button class="saveNewAddress save">SAVE ADDRESS</button>
                  </div>
                </div>
            </div><!-- pages -->
...
<script rel="script" type="text/javascript" src="{{ asset('js/pages/editAddress.js') }}"></script>
@append